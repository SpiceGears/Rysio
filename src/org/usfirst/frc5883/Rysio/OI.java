...
public class OI {
    ...
    public OI() {
        ...
        joystick1 = new Joystick(5);
        
        joystickButton5 = new JoystickButton(joystick1, 6);
        joystickButton5.whileHeld(new Shoot());
        joystickButton4 = new JoystickButton(joystick1, 5);
        joystickButton4.whileHeld(new Intake());
        joystickButton3 = new JoystickButton(joystick1, 2);
        joystickButton3.whileHeld(new Compressor());
        joystickButton2 = new JoystickButton(joystick1, 1);
        joystickButton2.whileHeld(new AimingDown());
        joystickButton1 = new JoystickButton(joystick1,3);
        joystickButton1.whileHeld(new AimingUp());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("AimingUp", new AimingUp());
        SmartDashboard.putData("AimingDown", new AimingDown());
        SmartDashboard.putData("Compressor", new Compressor());
